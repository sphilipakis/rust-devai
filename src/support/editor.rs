...
/// Returns the editor program if successful, None if no editor was found.
pub fn open_file_auto(path: &SPath) -> Result<Option<EditorProgram>> {
...
/// Detection order:
/// 1. ZED_TERM=true or TERM_PROGRAM=zed -> zed
/// 2. TERM_PROGRAM=vscode -> code
/// 3. TERM_PROGRAM for other known editors
